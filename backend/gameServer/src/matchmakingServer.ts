import { matchmakingPort } from "../../../config";

const port = matchmakingPort;

export function initMatchmakingServer() {
  ...
  console.log(`Matchmaking server is listening on port ${port}`);
